...
registerLanguagePack({
  ...
  /* ─────────────── LEVEL 1 ─────────────── */
  {
    ...
    words: [
      {w:'hola', ipa:'/ˈo.la/', m:{kr:'안녕하세요 (만능 인사)', en:'hello'}, pos:'표현', ex:'¡Hola! ¿Qué tal?', exm:{kr:'안녕! 어떻게 지내?'}},
      {w:'buenos días', ipa:'/ˈbwe.nos ˈdi.as/', m:{kr:'좋은 아침입니다', en:'good morning'}, pos:'표현', ex:'Buenos días, señora.', exm:{kr:'좋은 아침입니다, 부인.'}},
      {w:'buenas tardes', ipa:'/ˈbwe.nas ˈtaɾ.des/', m:{kr:'안녕하세요 (오후 인사)', en:'good afternoon'}, pos:'표현', ex:'Buenas tardes a todos.', exm:{kr:'여러분, 안녕하세요(오후).'}},
      {w:'buenas noches', ipa:'/ˈbwe.nas ˈno.tʃes/', m:{kr:'안녕하세요(저녁) / 잘 자요', en:'good evening / night'}, pos:'표현', ex:'Buenas noches, hasta mañana.', exm:{kr:'잘 자요, 내일 봐요.'}},
      {w:'adiós', ipa:'/aˈðjos/', m:{kr:'안녕히 가세요', en:'goodbye'}, pos:'표현', ex:'Adiós, hasta luego.', exm:{kr:'안녕, 나중에 봐.'}},
      {w:'hasta luego', ipa:'/ˈas.ta ˈlwe.ɣo/', m:{kr:'나중에 봐요', en:'see you later'}, pos:'표현', ex:'Me voy, ¡hasta luego!', exm:{kr:'나 갈게, 나중에 봐!'}},
      {w:'gracias', ipa:'/ˈɡɾa.sjas/', m:{kr:'감사합니다', en:'thank you'}, pos:'표현', ex:'Muchas gracias.', exm:{kr:'정말 감사합니다.'}},
      {w:'por favor', ipa:'/poɾ faˈβoɾ/', m:{kr:'부탁합니다', en:'please'}, pos:'표현', ex:'Un café, por favor.', exm:{kr:'커피 한 잔 부탁합니다.'}},
      {w:'perdón', ipa:'/peɾˈðon/', m:{kr:'실례합니다, 죄송합니다', en:'excuse me, sorry'}, pos:'표현', ex:'Perdón, ¿dónde está la estación?', exm:{kr:'실례합니다, 역이 어디에 있나요?'}},
      {w:'sí', ipa:'/si/', m:{kr:'네', en:'yes'}, pos:'부사', ex:'Sí, entiendo.', exm:{kr:'네, 이해합니다.'}},
      {w:'no', ipa:'/no/', m:{kr:'아니요', en:'no'}, pos:'부사', ex:'No, gracias.', exm:{kr:'아니요, 괜찮습니다.'}},
      {w:'señora', ipa:'/seˈɲo.ɾa/', m:{kr:'부인, ~씨 (여성 존칭)', en:'madam, Mrs.'}, pos:'명사', gender:'f', plural:'señoras', ex:'Buenos días, señora García.', exm:{kr:'좋은 아침입니다, 가르시아 부인.'}},
      {w:'señor', ipa:'/seˈɲoɾ/', m:{kr:'선생님, ~씨 (남성 존칭)', en:'sir, Mr.'}, pos:'명사', gender:'m', plural:'señores', ex:'Perdón, señor.', exm:{kr:'실례합니다, 선생님.'}},
      {w:'yo', ipa:'/ʝo/', m:{kr:'나는', en:'I'}, pos:'대명사', ex:'Yo soy coreano.', exm:{kr:'저는 한국인입니다.'}},
      {w:'tú', ipa:'/tu/', m:{kr:'너는 (친한 사이)', en:'you (informal)'}, pos:'대명사', ex:'Tú eres mi amigo.', exm:{kr:'너는 내 친구야.'}},
      {w:'él / ella', ipa:'/el/ /ˈe.ʝa/', m:{kr:'그는 / 그녀는', en:'he / she'}, pos:'대명사', gender:'mf', ex:'Él es alto. Ella es baja.', exm:{kr:'그는 키가 크다. 그녀는 키가 작다.'}},
      {w:'usted', ipa:'/usˈteð/', m:{kr:'당신은 (존칭)', en:'you (formal)'}, pos:'대명사', ex:'¿Cómo está usted?', exm:{kr:'어떻게 지내세요? (존칭)'}},
      {w:'nosotros / nosotras', ipa:'/noˈso.tɾos/', m:{kr:'우리는', en:'we'}, pos:'대명사', gender:'mf', ex:'Nosotros somos estudiantes.', exm:{kr:'우리는 학생입니다.'}},
      {w:'ellos / ellas', ipa:'/ˈe.ʝos/ /ˈe.ʝas/', m:{kr:'그들은 / 그녀들은', en:'they'}, pos:'대명사', gender:'mf', ex:'Ellos son españoles.', exm:{kr:'그들은 스페인 사람입니다.'}},
      {w:'el / la / los / las', ipa:'/el/ /la/ /los/ /las/', m:{kr:'그 (정관사)', en:'the'}, pos:'관사', gender:'mf', ex:'el pan, la manzana, los libros, las mesas', exm:{kr:'그 빵, 그 사과, 그 책들, 그 탁자들'}},
      {w:'un / una / unos / unas', ipa:'/un/ /ˈu.na/', m:{kr:'하나의 (부정관사)', en:'a / an / some'}, pos:'관사', gender:'mf', ex:'un libro, una mesa, unos amigos', exm:{kr:'책 한 권, 탁자 하나, 친구들'}},
      {w:'uno', ipa:'/ˈu.no/', m:{kr:'하나, 1', en:'one'}, pos:'숫자', ex:'Tengo un hermano.', exm:{kr:'나는 형제가 한 명 있다.'}},
      {w:'dos', ipa:'/dos/', m:{kr:'둘, 2', en:'two'}, pos:'숫자', ex:'Dos cafés, por favor.', exm:{kr:'커피 두 잔 부탁합니다.'}},
      {w:'tres', ipa:'/tɾes/', m:{kr:'셋, 3', en:'three'}, pos:'숫자', ex:'Hay tres gatos.', exm:{kr:'고양이 세 마리가 있다.'}},
      {w:'cuatro', ipa:'/ˈkwa.tɾo/', m:{kr:'넷, 4', en:'four'}, pos:'숫자', ex:'Somos cuatro.', exm:{kr:'우리는 네 명입니다.'}},
      {w:'cinco', ipa:'/ˈsiŋ.ko/', m:{kr:'다섯, 5', en:'five'}, pos:'숫자', ex:'Son las cinco.', exm:{kr:'5시입니다.'}},
      {w:'seis', ipa:'/sejs/', m:{kr:'여섯, 6', en:'six'}, pos:'숫자', ex:'Seis euros, por favor.', exm:{kr:'6유로입니다.'}},
      {w:'siete', ipa:'/ˈsje.te/', m:{kr:'일곱, 7', en:'seven'}, pos:'숫자', ex:'La semana tiene siete días.', exm:{kr:'일주일에는 7일이 있다.'}},
      {w:'ocho', ipa:'/ˈo.tʃo/', m:{kr:'여덟, 8', en:'eight'}, pos:'숫자', ex:'La tienda abre a las ocho.', exm:{kr:'가게는 8시에 문을 연다.'}},
      {w:'nueve', ipa:'/ˈnwe.βe/', m:{kr:'아홉, 9', en:'nine'}, pos:'숫자', ex:'Tengo nueve libros.', exm:{kr:'나는 책이 아홉 권 있다.'}},
      {w:'diez', ipa:'/djes/', m:{kr:'열, 10', en:'ten'}, pos:'숫자', ex:'Contar de uno a diez.', exm:{kr:'1부터 10까지 세기.'}}
    ],
    grammar: [
  ...
  /* ─────────────── LEVEL 2 ─────────────── */
  {
    ...
    words: [
      {w:'ser', ipa:'/seɾ/', m:{kr:'~이다 (본질·정체)', en:'to be (essence)'}, pos:'동사', ex:'Yo soy estudiante.', exm:{kr:'저는 학생입니다.'}},
      {w:'estar', ipa:'/esˈtaɾ/', m:{kr:'~이다, 있다 (상태·위치)', en:'to be (state/place)'}, pos:'동사', ex:'Estoy cansado.', exm:{kr:'나는 피곤하다.'}},
      {w:'tener', ipa:'/teˈneɾ/', m:{kr:'가지다', en:'to have'}, pos:'동사', ex:'Tengo un gato.', exm:{kr:'나는 고양이 한 마리가 있다.'}},
      {w:'ir', ipa:'/iɾ/', m:{kr:'가다', en:'to go'}, pos:'동사', ex:'Voy a Madrid.', exm:{kr:'나는 마드리드에 간다.'}},
      {w:'no (부정)', ipa:'/no/', m:{kr:'~하지 않다 (동사 앞에 no)', en:'not'}, pos:'표현', ex:'No hablo inglés.', exm:{kr:'나는 영어를 하지 못한다.'}},
      {w:'agua', ipa:'/ˈa.ɣwa/', m:{kr:'물 (여성이지만 el agua!)', en:'water'}, pos:'명사', gender:'f', plural:'aguas', ex:'Bebo agua.', exm:{kr:'나는 물을 마신다.'}},
      {w:'pan', ipa:'/pan/', m:{kr:'빵', en:'bread'}, pos:'명사', gender:'m', plural:'panes', ex:'El pan está delicioso.', exm:{kr:'그 빵은 맛있다.'}},
      {w:'casa', ipa:'/ˈka.sa/', m:{kr:'집', en:'house'}, pos:'명사', gender:'f', plural:'casas', ex:'Mi casa es pequeña.', exm:{kr:'우리 집은 작다.'}},
      {w:'escuela', ipa:'/esˈkwe.la/', m:{kr:'학교', en:'school'}, pos:'명사', gender:'f', plural:'escuelas', ex:'Voy a la escuela.', exm:{kr:'나는 학교에 간다.'}},
      {w:'libro', ipa:'/ˈli.βɾo/', m:{kr:'책', en:'book'}, pos:'명사', gender:'m', plural:'libros', ex:'Leo un libro.', exm:{kr:'나는 책을 읽는다.'}},
      {w:'día', ipa:'/ˈdi.a/', m:{kr:'날, 하루 (-a지만 남성!)', en:'day'}, pos:'명사', gender:'m', plural:'días', ex:'¿Qué día es hoy?', exm:{kr:'오늘 무슨 요일이죠?'}},
      {w:'noche', ipa:'/ˈno.tʃe/', m:{kr:'밤', en:'night'}, pos:'명사', gender:'f', plural:'noches', ex:'¡Buenas noches!', exm:{kr:'잘 자요!'}},
      {w:'amigo / amiga', ipa:'/aˈmi.ɣo/', m:{kr:'친구', en:'friend'}, pos:'명사', gender:'mf', plural:'amigos / amigas', ex:'Es mi amigo.', exm:{kr:'이 사람은 내 친구야.'}},
      {w:'gato', ipa:'/ˈɡa.to/', m:{kr:'고양이', en:'cat'}, pos:'명사', gender:'m', plural:'gatos', ex:'El gato duerme en la mesa.', exm:{kr:'고양이가 탁자 위에서 잔다.'}},
      {w:'perro', ipa:'/ˈpe.ro/', m:{kr:'개', en:'dog'}, pos:'명사', gender:'m', plural:'perros', ex:'El perro come.', exm:{kr:'개가 먹고 있다.'}},
      {w:'mesa', ipa:'/ˈme.sa/', m:{kr:'탁자, 식탁', en:'table'}, pos:'명사', gender:'f', plural:'mesas', ex:'El libro está en la mesa.', exm:{kr:'책이 탁자 위에 있다.'}},
      {w:'pequeño / pequeña', ipa:'/peˈke.ɲo(a)/', m:{kr:'작은', en:'small'}, pos:'형용사', gender:'mf', ex:'un gato pequeño / una casa pequeña', exm:{kr:'작은 고양이 / 작은 집'}},
      {w:'grande', ipa:'/ˈɡɾan.de/', m:{kr:'큰', en:'big'}, pos:'형용사', gender:'mf', ex:'una escuela grande', exm:{kr:'큰 학교'}},
      {w:'bueno / buena', ipa:'/ˈbwe.no(a)/', m:{kr:'좋은, 맛있는', en:'good'}, pos:'형용사', gender:'mf', ex:'Es un buen restaurante.', exm:{kr:'여기는 좋은 식당이다.'}},
      {w:'y', ipa:'/i/', m:{kr:'그리고', en:'and'}, pos:'접속사', ex:'un café y un cruasán', exm:{kr:'커피 한 잔과 크루아상 하나'}},
      {w:'pero', ipa:'/ˈpe.ɾo/', m:{kr:'하지만', en:'but'}, pos:'접속사', ex:'Es pequeño pero bonito.', exm:{kr:'작지만 예쁘다.'}},
      {w:'o', ipa:'/o/', m:{kr:'또는', en:'or'}, pos:'접속사', ex:'¿Té o café?', exm:{kr:'차요 아니면 커피요?'}},
      {w:'porque', ipa:'/ˈpoɾ.ke/', m:{kr:'왜냐하면', en:'because'}, pos:'접속사', ex:'Como porque tengo hambre.', exm:{kr:'배가 고파서 먹는다.'}},
      {w:'quién', ipa:'/kjen/', m:{kr:'누가, 누구', en:'who'}, pos:'의문사', ex:'¿Quién es?', exm:{kr:'이 사람은 누구예요?'}},
      {w:'qué', ipa:'/ke/', m:{kr:'무엇', en:'what'}, pos:'의문사', ex:'¿Qué es esto?', exm:{kr:'이게 뭐예요?'}},
      {w:'dónde', ipa:'/ˈdon.de/', m:{kr:'어디', en:'where'}, pos:'의문사', ex:'¿Dónde está la estación?', exm:{kr:'역이 어디에 있나요?'}},
      {w:'cuándo', ipa:'/ˈkwan.do/', m:{kr:'언제', en:'when'}, pos:'의문사', ex:'¿Cuándo llegas?', exm:{kr:'너 언제 도착해?'}},
      {w:'por qué', ipa:'/poɾ ˈke/', m:{kr:'왜', en:'why'}, pos:'의문사', ex:'¿Por qué estudias español?', exm:{kr:'너는 왜 스페인어를 공부해?'}},
      {w:'cómo', ipa:'/ˈko.mo/', m:{kr:'어떻게', en:'how'}, pos:'의문사', ex:'¿Cómo te llamas?', exm:{kr:'너 이름이 뭐야?'}}
    ],
    grammar: [
  ...
  /* ─────────────── LEVEL 3 ─────────────── */
  {
    ...
    words: [
      {w:'queso', ipa:'/ˈke.so/', m:{kr:'치즈', en:'cheese'}, pos:'명사', gender:'m', plural:'quesos', ex:'Quisiera queso, por favor.', exm:{kr:'치즈를 주세요.'}},
      {w:'manzana', ipa:'/manˈsa.na/', m:{kr:'사과', en:'apple'}, pos:'명사', gender:'f', plural:'manzanas', ex:'Como una manzana roja.', exm:{kr:'나는 빨간 사과를 먹는다.'}},
      {w:'verdura', ipa:'/beɾˈðu.ɾa/', m:{kr:'채소', en:'vegetable'}, pos:'명사', gender:'f', plural:'verduras', ex:'Las verduras son buenas para la salud.', exm:{kr:'채소는 건강에 좋다.'}},
      {w:'carne', ipa:'/ˈkaɾ.ne/', m:{kr:'고기', en:'meat'}, pos:'명사', gender:'f', plural:'carnes', ex:'No como carne.', exm:{kr:'나는 고기를 먹지 않는다.'}},
      {w:'pescado', ipa:'/pesˈka.ðo/', m:{kr:'생선', en:'fish'}, pos:'명사', gender:'m', plural:'pescados', ex:'El pescado está fresco.', exm:{kr:'생선이 신선하다.'}},
      {w:'restaurante', ipa:'/res.tawˈɾan.te/', m:{kr:'식당', en:'restaurant'}, pos:'명사', gender:'m', plural:'restaurantes', ex:'Vamos al restaurante esta noche.', exm:{kr:'우리는 오늘 저녁 식당에 간다.'}},
      {w:'menú', ipa:'/meˈnu/', m:{kr:'메뉴', en:'menu'}, pos:'명사', gender:'m', plural:'menús', ex:'El menú, por favor.', exm:{kr:'메뉴판 주세요.'}},
      {w:'bebida', ipa:'/beˈβi.ða/', m:{kr:'음료', en:'drink'}, pos:'명사', gender:'f', plural:'bebidas', ex:'¿Qué bebida quiere?', exm:{kr:'어떤 음료를 드릴까요?'}},
      {w:'desayuno', ipa:'/de.saˈʝu.no/', m:{kr:'아침 식사', en:'breakfast'}, pos:'명사', gender:'m', plural:'desayunos', ex:'Tomo el desayuno a las siete.', exm:{kr:'나는 7시에 아침을 먹는다.'}},
      {w:'delicioso / deliciosa', ipa:'/de.liˈsjo.so(a)/', m:{kr:'맛있는', en:'delicious'}, pos:'형용사', gender:'mf', ex:'¡Esta tarta está deliciosa!', exm:{kr:'이 타르트 정말 맛있다!'}},
      {w:'comer', ipa:'/koˈmeɾ/', m:{kr:'먹다', en:'to eat'}, pos:'동사', ex:'Como una manzana.', exm:{kr:'나는 사과를 먹는다.'}},
      {w:'beber', ipa:'/beˈβeɾ/', m:{kr:'마시다', en:'to drink'}, pos:'동사', ex:'Bebo agua.', exm:{kr:'나는 물을 마신다.'}},
      {w:'pedir', ipa:'/peˈðiɾ/', m:{kr:'주문하다, 부탁하다 (e→i)', en:'to order'}, pos:'동사', ex:'Pedimos dos cafés.', exm:{kr:'우리는 커피 두 잔을 주문한다.'}},
      {w:'quisiera', ipa:'/kiˈsje.ɾa/', m:{kr:'~을 주세요 (정중한 요청)', en:'I would like'}, pos:'표현', ex:'Quisiera un cruasán, por favor.', exm:{kr:'크루아상 하나 주세요.'}}
    ],
    grammar: [
  ...
  /* ─────────────── LEVEL 4 ─────────────── */
  {
    ...
    words: [
      {w:'familia', ipa:'/faˈmi.lja/', m:{kr:'가족', en:'family'}, pos:'명사', gender:'f', plural:'familias', ex:'Mi familia vive en Seúl.', exm:{kr:'우리 가족은 서울에 산다.'}},
      {w:'padre', ipa:'/ˈpa.ðɾe/', m:{kr:'아버지', en:'father'}, pos:'명사', gender:'m', plural:'padres', ex:'Mi padre trabaja mucho.', exm:{kr:'우리 아버지는 일을 많이 하신다.'}},
      {w:'madre', ipa:'/ˈma.ðɾe/', m:{kr:'어머니', en:'mother'}, pos:'명사', gender:'f', plural:'madres', ex:'Mi madre cocina muy bien.', exm:{kr:'우리 어머니는 요리를 아주 잘하신다.'}},
      {w:'hermano', ipa:'/eɾˈma.no/', m:{kr:'형, 오빠, 남동생', en:'brother'}, pos:'명사', gender:'m', plural:'hermanos', ex:'Tengo dos hermanos.', exm:{kr:'나는 형제가 둘 있다.'}},
      {w:'hermana', ipa:'/eɾˈma.na/', m:{kr:'누나, 언니, 여동생', en:'sister'}, pos:'명사', gender:'f', plural:'hermanas', ex:'Mi hermana es médica.', exm:{kr:'우리 언니는 의사다.'}},
      {w:'niño / niña', ipa:'/ˈni.ɲo(a)/', m:{kr:'아이', en:'child'}, pos:'명사', gender:'mf', plural:'niños / niñas', ex:'Los niños juegan en el jardín.', exm:{kr:'아이들이 정원에서 놀고 있다.'}},
      {w:'mi / mis', ipa:'/mi/ /mis/', m:{kr:'나의 (소유형용사)', en:'my'}, pos:'관사', ex:'mi padre, mi madre, mis padres', exm:{kr:'나의 아버지, 나의 어머니, 나의 부모님'}},
      {w:'tiempo', ipa:'/ˈtjem.po/', m:{kr:'날씨; 시간', en:'weather; time'}, pos:'명사', gender:'m', plural:'tiempos', ex:'¿Qué tiempo hace?', exm:{kr:'날씨가 어떻습니까?'}},
      {w:'lluvia', ipa:'/ˈʝu.βja/', m:{kr:'비', en:'rain'}, pos:'명사', gender:'f', plural:'lluvias', ex:'Llueve. / La lluvia cae.', exm:{kr:'비가 온다.'}},
      {w:'sol', ipa:'/sol/', m:{kr:'해, 태양', en:'sun'}, pos:'명사', gender:'m', plural:'soles', ex:'Hace sol hoy.', exm:{kr:'오늘은 해가 떴다.'}},
      {w:'nieve', ipa:'/ˈnje.βe/', m:{kr:'눈', en:'snow'}, pos:'명사', gender:'f', plural:'nieves', ex:'Nieva en invierno.', exm:{kr:'겨울에는 눈이 온다.'}},
      {w:'hace buen tiempo', ipa:'/ˈa.se bwen ˈtjem.po/', m:{kr:'날씨가 좋다', en:'the weather is nice'}, pos:'표현', ex:'Hace buen tiempo, ¡vamos al parque!', exm:{kr:'날씨가 좋으니 공원에 가자!'}}
    ],
    grammar: [
  ...
  /* ─────────────── LEVEL 5 ─────────────── */
  {
    ...
    words: [
      {w:'levantarse', ipa:'/le.βanˈtaɾ.se/', m:{kr:'일어나다 (재귀동사)', en:'to get up'}, pos:'동사', ex:'Me levanto a las siete.', exm:{kr:'나는 7시에 일어난다.'}},
      {w:'trabajar', ipa:'/tɾa.βaˈxaɾ/', m:{kr:'일하다', en:'to work'}, pos:'동사', ex:'Trabajo en una oficina.', exm:{kr:'나는 사무실에서 일한다.'}},
      {w:'dormir', ipa:'/doɾˈmiɾ/', m:{kr:'자다 (o→ue)', en:'to sleep'}, pos:'동사', ex:'Duermo ocho horas cada noche.', exm:{kr:'나는 매일 밤 8시간 잔다.'}},
      {w:'mañana', ipa:'/maˈɲa.na/', m:{kr:'아침(la mañana); 내일(부사)', en:'morning; tomorrow'}, pos:'명사', gender:'f', plural:'mañanas', ex:'Por la mañana bebo un café. / ¡Hasta mañana!', exm:{kr:'아침에 나는 커피를 마신다. / 내일 봐!'}},
      {w:'tarde', ipa:'/ˈtaɾ.ðe/', m:{kr:'오후; 늦게', en:'afternoon; late'}, pos:'명사', gender:'f', plural:'tardes', ex:'Por la tarde estudio español.', exm:{kr:'오후에 나는 스페인어를 공부한다.'}},
      {w:'semana', ipa:'/seˈma.na/', m:{kr:'주, 일주일', en:'week'}, pos:'명사', gender:'f', plural:'semanas', ex:'Trabajo cinco días por semana.', exm:{kr:'나는 일주일에 5일 일한다.'}},
      {w:'hoy', ipa:'/oj/', m:{kr:'오늘', en:'today'}, pos:'부사', ex:'Hoy hace buen tiempo.', exm:{kr:'오늘은 날씨가 좋다.'}},
      {w:'cada', ipa:'/ˈka.ða/', m:{kr:'각각의, ~마다', en:'each, every'}, pos:'형용사', ex:'Estudio cada día.', exm:{kr:'나는 매일 공부한다.'}}
    ],
    grammar: [
  ...
  /* ─────────────── LEVEL 6 ─────────────── */
  {
    ...
    words: [
      {w:'ayer', ipa:'/aˈʝeɾ/', m:{kr:'어제', en:'yesterday'}, pos:'부사', ex:'Ayer comí en un restaurante.', exm:{kr:'어제 나는 식당에서 먹었다.'}},
      {w:'ya', ipa:'/ʝa/', m:{kr:'이미, 벌써', en:'already'}, pos:'부사', ex:'Ya terminé.', exm:{kr:'나는 이미 끝냈다.'}},
      {w:'fin de semana', ipa:'/fin de seˈma.na/', m:{kr:'주말', en:'weekend'}, pos:'명사', gender:'m', plural:'fines de semana', ex:'El fin de semana descanso.', exm:{kr:'주말에 나는 쉰다.'}},
      {w:'vacaciones', ipa:'/ba.kaˈsjo.nes/', m:{kr:'방학, 휴가 (항상 복수)', en:'vacation'}, pos:'명사', gender:'f', ex:'Estoy de vacaciones.', exm:{kr:'나는 휴가 중이다.'}},
      {w:'museo', ipa:'/muˈse.o/', m:{kr:'박물관', en:'museum'}, pos:'명사', gender:'m', plural:'museos', ex:'Visitamos un museo.', exm:{kr:'우리는 박물관을 관람했다.'}},
      {w:'viajar', ipa:'/bjaˈxaɾ/', m:{kr:'여행하다', en:'to travel'}, pos:'동사', ex:'Me gusta viajar por Europa.', exm:{kr:'나는 유럽 여행을 좋아한다.'}},
      {w:'visitar', ipa:'/bi.siˈtaɾ/', m:{kr:'방문하다', en:'to visit'}, pos:'동사', ex:'Visitaron Madrid.', exm:{kr:'그들은 마드리드를 방문했다.'}},
      {w:'comprar', ipa:'/komˈpɾaɾ/', m:{kr:'사다', en:'to buy'}, pos:'동사', ex:'Ella compró pan.', exm:{kr:'그녀는 빵을 샀다.'}},
      {w:'tomar', ipa:'/toˈmaɾ/', m:{kr:'잡다, 타다, 마시다/먹다', en:'to take'}, pos:'동사', ex:'Tomo el autobús.', exm:{kr:'나는 버스를 탄다.'}},
      {w:'ver', ipa:'/beɾ/', m:{kr:'보다', en:'to see'}, pos:'동사', ex:'Vimos una película.', exm:{kr:'우리는 영화를 봤다.'}}
    ],
    grammar: [
  ...
  /* ─────────────── LEVEL 7 ─────────────── */
  {
    ...
    words: [
      {w:'a menudo', ipa:'/a meˈnu.ðo/', m:{kr:'자주', en:'often'}, pos:'부사', ex:'Voy a menudo al cine.', exm:{kr:'나는 영화관에 자주 간다.'}},
      {w:'siempre', ipa:'/ˈsjem.pɾe/', m:{kr:'항상', en:'always'}, pos:'부사', ex:'Él siempre llega tarde.', exm:{kr:'그는 항상 늦는다.'}},
      {w:'nunca', ipa:'/ˈnuŋ.ka/', m:{kr:'결코 ~않다', en:'never'}, pos:'부사', ex:'Nunca bebo café por la noche.', exm:{kr:'나는 밤에 커피를 절대 마시지 않는다.'}},
      {w:'antes', ipa:'/ˈan.tes/', m:{kr:'전에, 예전에', en:'before'}, pos:'부사', ex:'Antes vivía en Busan.', exm:{kr:'예전에 나는 부산에 살았다.'}},
      {w:'después', ipa:'/desˈpwes/', m:{kr:'후에, 나중에', en:'after'}, pos:'부사', ex:'Después de cenar, leo.', exm:{kr:'저녁 식사 후에 나는 책을 읽는다.'}},
      {w:'año', ipa:'/ˈa.ɲo/', m:{kr:'해, 연도', en:'year'}, pos:'명사', gender:'m', plural:'años', ex:'¡Feliz año nuevo!', exm:{kr:'새해 복 많이 받으세요!'}},
      {w:'próximo / próxima', ipa:'/ˈpɾok.si.mo(a)/', m:{kr:'다음의', en:'next'}, pos:'형용사', gender:'mf', ex:'la semana próxima', exm:{kr:'다음 주'}},
      {w:'pasado / pasada', ipa:'/paˈsa.ðo(a)/', m:{kr:'지난', en:'last'}, pos:'형용사', gender:'mf', ex:'el año pasado', exm:{kr:'작년'}},
      {w:'vivir', ipa:'/biˈβiɾ/', m:{kr:'살다', en:'to live'}, pos:'동사', ex:'Vivo en Seúl.', exm:{kr:'나는 서울에 산다.'}},
      {w:'jugar', ipa:'/xuˈɣaɾ/', m:{kr:'놀다, (경기를) 하다 (u→ue)', en:'to play'}, pos:'동사', ex:'Los niños juegan al fútbol.', exm:{kr:'아이들이 축구를 한다.'}}
    ],
    grammar: [
  ...
  /* ─────────────── LEVEL 8 ─────────────── */
  {
    ...
    words: [
      {w:'lo / la / los / las (목적어)', ipa:'/lo/ /la/', m:{kr:'그를/그녀를/그것들을 (직접목적어)', en:'him/her/them'}, pos:'대명사', gender:'mf', ex:'Lo conozco bien.', exm:{kr:'나는 그를 잘 안다.'}},
      {w:'le / les', ipa:'/le/ /les/', m:{kr:'그(녀)에게 / 그들에게 (간접목적어)', en:'to him/her/them'}, pos:'대명사', ex:'Le hablo todos los días.', exm:{kr:'나는 매일 그(녀)에게 말한다.'}},
      {w:'gustar', ipa:'/ɡusˈtaɾ/', m:{kr:'좋아하다 (역구조: ~이 마음에 들다)', en:'to like'}, pos:'동사', ex:'Me gusta el chocolate.', exm:{kr:'나는 초콜릿을 좋아한다.'}},
      {w:'tener hambre', ipa:'/teˈneɾ ˈam.bɾe/', m:{kr:'배고프다', en:'to be hungry'}, pos:'표현', ex:'¡Tengo mucha hambre!', exm:{kr:'나 정말 배고파!'}},
      {w:'tener sed', ipa:'/teˈneɾ seð/', m:{kr:'목마르다', en:'to be thirsty'}, pos:'표현', ex:'¿Tienes sed? Aquí hay agua.', exm:{kr:'목말라? 여기 물 있어.'}},
      {w:'necesitar', ipa:'/ne.se.siˈtaɾ/', m:{kr:'~이 필요하다', en:'to need'}, pos:'동사', ex:'Necesito dormir.', exm:{kr:'나는 잠이 필요하다.'}},
      {w:'hay', ipa:'/aj/', m:{kr:'~이 있다', en:'there is/are'}, pos:'표현', ex:'Hay un gato en la mesa.', exm:{kr:'탁자 위에 고양이가 있다.'}},
      {w:'pensar en', ipa:'/penˈsaɾ en/', m:{kr:'~을 생각하다 (e→ie)', en:'to think about'}, pos:'동사', ex:'Pienso en mis vacaciones.', exm:{kr:'나는 휴가를 생각한다.'}},
      {w:'conocer', ipa:'/ko.noˈseɾ/', m:{kr:'알다 (사람·장소)', en:'to know'}, pos:'동사', ex:'Conozco este restaurante.', exm:{kr:'나는 이 식당을 안다.'}},
      {w:'querer', ipa:'/keˈɾeɾ/', m:{kr:'원하다, 사랑하다 (e→ie)', en:'to want, to love'}, pos:'동사', ex:'Quiero un café. / Te quiero.', exm:{kr:'커피 마시고 싶어. / 사랑해.'}}
    ],
    grammar: [
  ...
  /* ─────────────── LEVEL 9 ─────────────── */
  {
    ...
    words: [
      {w:'pensar', ipa:'/penˈsaɾ/', m:{kr:'생각하다 (e→ie)', en:'to think'}, pos:'동사', ex:'Pienso que es una buena idea.', exm:{kr:'좋은 생각인 것 같아.'}},
      {w:'creer', ipa:'/kɾeˈeɾ/', m:{kr:'믿다, ~라고 생각하다', en:'to believe'}, pos:'동사', ex:'Creo que él tiene razón.', exm:{kr:'그가 옳다고 생각해.'}},
      {w:'es importante que', ipa:'/es im.poɾˈtan.te ke/', m:{kr:'~하는 것이 중요하다 (+subjuntivo)', en:'it is important that'}, pos:'표현', ex:'Es importante que seas puntual.', exm:{kr:'네가 시간을 지키는 것이 중요해.'}},
      {w:'aunque', ipa:'/ˈawŋ.ke/', m:{kr:'비록 ~이지만', en:'although'}, pos:'접속사', ex:'Aunque tenga hambre, no come.', exm:{kr:'그는 배가 고파도 먹지 않는다.'}},
      {w:'en mi opinión', ipa:'/en mi o.piˈnjon/', m:{kr:'내 생각에는', en:'in my opinion'}, pos:'표현', ex:'En mi opinión, esta película es excelente.', exm:{kr:'내 생각에 이 영화는 훌륭하다.'}},
      {w:'opinión', ipa:'/o.piˈnjon/', m:{kr:'의견', en:'opinion'}, pos:'명사', gender:'f', plural:'opiniones', ex:'¿Cuál es tu opinión?', exm:{kr:'네 의견은 뭐야?'}},
      {w:'importante', ipa:'/im.poɾˈtan.te/', m:{kr:'중요한', en:'important'}, pos:'형용사', ex:'Es una decisión importante.', exm:{kr:'이것은 중요한 결정이다.'}},
      {w:'necesario / necesaria', ipa:'/ne.seˈsa.ɾjo(a)/', m:{kr:'필요한', en:'necessary'}, pos:'형용사', gender:'mf', ex:'Es necesario practicar.', exm:{kr:'연습이 필요하다.'}},
      {w:'parecer', ipa:'/pa.ɾeˈseɾ/', m:{kr:'~인 것 같다', en:'to seem'}, pos:'동사', ex:'Parece contento.', exm:{kr:'그는 만족스러워 보인다.'}},
      {w:'tener razón', ipa:'/teˈneɾ raˈson/', m:{kr:'옳다, 맞다', en:'to be right'}, pos:'표현', ex:'Tienes razón, es verdad.', exm:{kr:'네 말이 맞아, 사실이야.'}}
    ],
    grammar: [
  ...
  /* ─────────────── LEVEL 10 ─────────────── */
  {
    ...
    words: [
      {w:'sin embargo', ipa:'/sin emˈbaɾ.ɣo/', m:{kr:'그러나 (격식)', en:'however'}, pos:'접속사', ex:'La película era larga; sin embargo, no me aburrí.', exm:{kr:'영화는 길었다. 그러나 지루하지 않았다.'}},
      {w:'no obstante', ipa:'/no obsˈtan.te/', m:{kr:'그럼에도 불구하고 (문어)', en:'nonetheless'}, pos:'부사', ex:'Es difícil; no obstante, lo intentaré.', exm:{kr:'어렵다. 그럼에도 시도해 보겠다.'}},
      {w:'a pesar de', ipa:'/a peˈsaɾ ðe/', m:{kr:'~에도 불구하고', en:'despite'}, pos:'전치사', ex:'A pesar de la lluvia, salimos.', exm:{kr:'비에도 불구하고 우리는 나갔다.'}},
      {w:'para que', ipa:'/ˈpa.ɾa ke/', m:{kr:'~하도록 (+subjuntivo)', en:'so that'}, pos:'접속사', ex:'Estudio para que mi futuro sea mejor.', exm:{kr:'나는 더 나은 미래를 위해 공부한다.'}},
      {w:'si', ipa:'/si/', m:{kr:'만약 ~라면', en:'if'}, pos:'접속사', ex:'Si fuera rico, viajaría.', exm:{kr:'내가 부자라면 여행할 텐데.'}},
      {w:'poder (podría)', ipa:'/poˈðeɾ/', m:{kr:'~할 수 있다 (조건법: ~해 주시겠어요?)', en:'could'}, pos:'동사', ex:'¿Podría ayudarme?', exm:{kr:'저를 도와주실 수 있을까요?'}},
      {w:'deber (deberías)', ipa:'/deˈβeɾ/', m:{kr:'~해야 한다 (조건법: ~하는 게 좋겠다)', en:'should'}, pos:'동사', ex:'Deberías dormir más.', exm:{kr:'너는 잠을 더 자는 게 좋겠어.'}},
      {w:'desear', ipa:'/de.seˈaɾ/', m:{kr:'바라다, 원하다 (격식)', en:'to wish'}, pos:'동사', ex:'Desearía reservar una mesa.', exm:{kr:'테이블을 예약하고 싶습니다만.'}},
      {w:'expresar', ipa:'/eks.pɾeˈsaɾ/', m:{kr:'표현하다', en:'to express'}, pos:'동사', ex:'Expresa bien sus ideas.', exm:{kr:'그는 자기 생각을 잘 표현한다.'}},
      {w:'quizás', ipa:'/kiˈsas/', m:{kr:'아마도 (+subjuntivo 가능)', en:'perhaps'}, pos:'부사', ex:'Quizás venga mañana.', exm:{kr:'그는 아마 내일 올 것이다.'}}
    ],
    grammar: [
