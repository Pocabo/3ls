...
registerLanguagePack({
  id: 'fr',
  target: 'fr',          // 학습 언어. 지원 base(설명 언어)는 각 단어 m 의 키로 자동 결정(kr·en)
  name: '프랑스어',
  nativeName: 'Français',
  flag: '🇫🇷',
  tts: 'fr-FR',
  ...
  /* ─────────────── LEVEL 1 ─────────────── */
  {
    ...
    words: [
      {w:'bonjour', ipa:'/bɔ̃.ʒuʁ/', m:{kr:'안녕하세요 (낮 인사)', en:'hello'}, pos:'표현', ex:'Bonjour, comment allez-vous ?', exm:{kr:'안녕하세요, 어떻게 지내세요?'}},
      {w:'bonsoir', ipa:'/bɔ̃.swaʁ/', m:{kr:'안녕하세요 (저녁 인사)', en:'good evening'}, pos:'표현', ex:'Bonsoir, madame !', exm:{kr:'안녕하세요(저녁), 부인!'}},
      {w:'salut', ipa:'/sa.ly/', m:{kr:'안녕 (친한 사이)', en:'hi / bye'}, pos:'표현', ex:'Salut, ça va ?', exm:{kr:'안녕, 잘 지내?'}},
      {w:'au revoir', ipa:'/o ʁə.vwaʁ/', m:{kr:'안녕히 가세요', en:'goodbye'}, pos:'표현', ex:'Au revoir, à demain !', exm:{kr:'안녕히 가세요, 내일 봬요!'}},
      {w:'merci', ipa:'/mɛʁ.si/', m:{kr:'감사합니다', en:'thank you'}, pos:'표현', ex:'Merci beaucoup !', exm:{kr:'정말 감사합니다!'}},
      {w:"s'il vous plaît", ipa:'/sil vu plɛ/', m:{kr:'부탁합니다', en:'please'}, pos:'표현', ex:"Un café, s'il vous plaît.", exm:{kr:'커피 한 잔 부탁합니다.'}},
      {w:'pardon', ipa:'/paʁ.dɔ̃/', m:{kr:'실례합니다, 죄송합니다', en:'excuse me'}, pos:'표현', ex:'Pardon, où est la gare ?', exm:{kr:'실례합니다, 역이 어디에 있나요?'}},
      {w:'oui', ipa:'/wi/', m:{kr:'네', en:'yes'}, pos:'부사', ex:'Oui, je comprends.', exm:{kr:'네, 이해합니다.'}},
      {w:'non', ipa:'/nɔ̃/', m:{kr:'아니요', en:'no'}, pos:'부사', ex:'Non, merci.', exm:{kr:'아니요, 괜찮습니다.'}},
      {w:'ça va', ipa:'/sa va/', m:{kr:'잘 지내요 / 잘 지내?', en:'I\'m fine / how\'s it going?'}, pos:'표현', ex:'— Ça va ? — Oui, ça va bien, merci.', exm:{kr:'— 잘 지내? — 응, 잘 지내, 고마워.'}},
      {w:'madame', ipa:'/ma.dam/', m:{kr:'부인, ~씨 (여성 존칭)', en:'madam'}, pos:'명사', gender:'f', plural:'mesdames', ex:'Bonjour, madame Dupont.', exm:{kr:'안녕하세요, 뒤퐁 부인.'}},
      {w:'monsieur', ipa:'/mə.sjø/', m:{kr:'선생님, ~씨 (남성 존칭)', en:'sir'}, pos:'명사', gender:'m', plural:'messieurs', ex:'Excusez-moi, monsieur.', exm:{kr:'실례합니다, 선생님.'}},
      {w:'je', ipa:'/ʒə/', m:{kr:'나는, 저는', en:'I'}, pos:'대명사', ex:'Je suis coréen.', exm:{kr:'저는 한국인입니다.'}},
      {w:'tu', ipa:'/ty/', m:{kr:'너는 (친한 사이)', en:'you (informal)'}, pos:'대명사', ex:'Tu es mon ami.', exm:{kr:'너는 내 친구야.'}},
      {w:'il / elle', ipa:'/il/ /ɛl/', m:{kr:'그는 / 그녀는', en:'he / she'}, pos:'대명사', gender:'mf', ex:'Il est grand. Elle est petite.', exm:{kr:'그는 키가 크다. 그녀는 키가 작다.'}},
      {w:'nous', ipa:'/nu/', m:{kr:'우리는', en:'we'}, pos:'대명사', ex:'Nous sommes étudiants.', exm:{kr:'우리는 학생입니다.'}},
      {w:'vous', ipa:'/vu/', m:{kr:'당신(들)은 (존칭·복수)', en:'you (formal/plural)'}, pos:'대명사', ex:'Vous êtes très gentil.', exm:{kr:'당신은 매우 친절하시네요.'}},
      {w:'ils / elles', ipa:'/il/ /ɛl/', m:{kr:'그들은 / 그녀들은', en:'they'}, pos:'대명사', gender:'mf', ex:'Ils sont français.', exm:{kr:'그들은 프랑스인입니다.'}},
      {w:'le / la / les', ipa:'/lə/ /la/ /le/', m:{kr:'그 (정관사)', en:'the'}, pos:'관사', gender:'mf', ex:'le pain, la pomme, les livres', exm:{kr:'그 빵, 그 사과, 그 책들'}},
      {w:'un / une / des', ipa:'/œ̃/ /yn/ /de/', m:{kr:'하나의 (부정관사)', en:'a / an / some'}, pos:'관사', gender:'mf', ex:'un livre, une table, des amis', exm:{kr:'책 한 권, 탁자 하나, 친구들'}},
      {w:'un', ipa:'/œ̃/', m:{kr:'하나, 1', en:'one'}, pos:'숫자', ex:"J'ai un frère.", exm:{kr:'나는 형제가 한 명 있다.'}},
      {w:'deux', ipa:'/dø/', m:{kr:'둘, 2', en:'two'}, pos:'숫자', ex:"Deux cafés, s'il vous plaît.", exm:{kr:'커피 두 잔 부탁합니다.'}},
      {w:'trois', ipa:'/tʁwɑ/', m:{kr:'셋, 3', en:'three'}, pos:'숫자', ex:'Il y a trois chats.', exm:{kr:'고양이 세 마리가 있다.'}},
      {w:'quatre', ipa:'/katʁ/', m:{kr:'넷, 4', en:'four'}, pos:'숫자', ex:'Nous sommes quatre.', exm:{kr:'우리는 네 명입니다.'}},
      {w:'cinq', ipa:'/sɛ̃k/', m:{kr:'다섯, 5', en:'five'}, pos:'숫자', ex:'Il est cinq heures.', exm:{kr:'5시입니다.'}},
      {w:'six', ipa:'/sis/', m:{kr:'여섯, 6', en:'six'}, pos:'숫자', ex:"Six euros, s'il vous plaît.", exm:{kr:'6유로입니다.'}},
      {w:'sept', ipa:'/sɛt/', m:{kr:'일곱, 7', en:'seven'}, pos:'숫자', ex:'Il y a sept jours dans une semaine.', exm:{kr:'일주일에는 7일이 있다.'}},
      {w:'huit', ipa:'/ɥit/', m:{kr:'여덟, 8', en:'eight'}, pos:'숫자', ex:'Le magasin ouvre à huit heures.', exm:{kr:'가게는 8시에 문을 연다.'}},
      {w:'neuf', ipa:'/nœf/', m:{kr:'아홉, 9', en:'nine'}, pos:'숫자', ex:"J'ai neuf livres.", exm:{kr:'나는 책이 아홉 권 있다.'}},
      {w:'dix', ipa:'/dis/', m:{kr:'열, 10', en:'ten'}, pos:'숫자', ex:'Compter de un à dix.', exm:{kr:'1부터 10까지 세기.'}}
    ],
    grammar: [
  ...
  /* ─────────────── LEVEL 2 ─────────────── */
  {
    ...
    words: [
      {w:'être', ipa:'/ɛtʁ/', m:{kr:'~이다, 있다', en:'to be'}, pos:'동사', ex:'Je suis étudiant.', exm:{kr:'저는 학생입니다.'}},
      {w:'avoir', ipa:'/a.vwaʁ/', m:{kr:'가지다, 있다', en:'to have'}, pos:'동사', ex:"J'ai un chat.", exm:{kr:'나는 고양이 한 마리가 있다.'}},
      {w:'aller', ipa:'/a.le/', m:{kr:'가다', en:'to go'}, pos:'동사', ex:'Je vais à Paris.', exm:{kr:'나는 파리에 간다.'}},
      {w:'faire', ipa:'/fɛʁ/', m:{kr:'하다, 만들다', en:'to do, to make'}, pos:'동사', ex:'Je fais du sport.', exm:{kr:'나는 운동을 한다.'}},
      {w:'ne ... pas', ipa:'/nə pa/', m:{kr:'~하지 않다 (부정문)', en:'not'}, pos:'표현', ex:'Je ne parle pas anglais.', exm:{kr:'나는 영어를 하지 못한다.'}},
      {w:'eau', ipa:'/o/', m:{kr:'물', en:'water'}, pos:'명사', gender:'f', plural:'eaux', ex:"Je bois de l'eau.", exm:{kr:'나는 물을 마신다.'}},
      {w:'pain', ipa:'/pɛ̃/', m:{kr:'빵', en:'bread'}, pos:'명사', gender:'m', plural:'pains', ex:'Le pain est délicieux.', exm:{kr:'그 빵은 맛있다.'}},
      {w:'maison', ipa:'/mɛ.zɔ̃/', m:{kr:'집', en:'house'}, pos:'명사', gender:'f', plural:'maisons', ex:'Ma maison est petite.', exm:{kr:'우리 집은 작다.'}},
      {w:'école', ipa:'/e.kɔl/', m:{kr:'학교', en:'school'}, pos:'명사', gender:'f', plural:'écoles', ex:"Je vais à l'école.", exm:{kr:'나는 학교에 간다.'}},
      {w:'livre', ipa:'/livʁ/', m:{kr:'책', en:'book'}, pos:'명사', gender:'m', plural:'livres', ex:'Je lis un livre.', exm:{kr:'나는 책을 읽는다.'}},
      {w:'jour', ipa:'/ʒuʁ/', m:{kr:'날, 하루', en:'day'}, pos:'명사', gender:'m', plural:'jours', ex:'Quel jour sommes-nous ?', exm:{kr:'오늘이 무슨 요일이죠?'}},
      {w:'nuit', ipa:'/nɥi/', m:{kr:'밤', en:'night'}, pos:'명사', gender:'f', plural:'nuits', ex:'Bonne nuit !', exm:{kr:'잘 자요!'}},
      {w:'ami / amie', ipa:'/a.mi/', m:{kr:'친구', en:'friend'}, pos:'명사', gender:'mf', plural:'amis / amies', ex:"C'est mon ami.", exm:{kr:'이 사람은 내 친구야.'}},
      {w:'chat', ipa:'/ʃa/', m:{kr:'고양이', en:'cat'}, pos:'명사', gender:'m', plural:'chats', ex:'Le chat dort sur la table.', exm:{kr:'고양이가 탁자 위에서 자고 있다.'}},
      {w:'chien', ipa:'/ʃjɛ̃/', m:{kr:'개', en:'dog'}, pos:'명사', gender:'m', plural:'chiens', ex:'Le chien mange.', exm:{kr:'개가 먹고 있다.'}},
      {w:'table', ipa:'/tabl/', m:{kr:'탁자, 식탁', en:'table'}, pos:'명사', gender:'f', plural:'tables', ex:'Le livre est sur la table.', exm:{kr:'책이 탁자 위에 있다.'}},
      {w:'petit / petite', ipa:'/pə.ti(t)/', m:{kr:'작은', en:'small'}, pos:'형용사', gender:'mf', ex:'un petit chat / une petite maison', exm:{kr:'작은 고양이 / 작은 집'}},
      {w:'grand / grande', ipa:'/ɡʁɑ̃(d)/', m:{kr:'큰, 키가 큰', en:'big, tall'}, pos:'형용사', gender:'mf', ex:'une grande école', exm:{kr:'큰 학교'}},
      {w:'bon / bonne', ipa:'/bɔ̃(n)/', m:{kr:'좋은, 맛있는', en:'good'}, pos:'형용사', gender:'mf', ex:"C'est un bon restaurant.", exm:{kr:'여기는 좋은 식당이다.'}},
      {w:'et', ipa:'/e/', m:{kr:'그리고', en:'and'}, pos:'접속사', ex:'un café et un croissant', exm:{kr:'커피 한 잔과 크루아상 하나'}},
      {w:'mais', ipa:'/mɛ/', m:{kr:'하지만', en:'but'}, pos:'접속사', ex:"C'est petit mais joli.", exm:{kr:'작지만 예쁘다.'}},
      {w:'ou', ipa:'/u/', m:{kr:'또는', en:'or'}, pos:'접속사', ex:'Thé ou café ?', exm:{kr:'차요 아니면 커피요?'}},
      {w:'parce que', ipa:'/paʁs kə/', m:{kr:'왜냐하면', en:'because'}, pos:'접속사', ex:"Je mange parce que j'ai faim.", exm:{kr:'배가 고파서 먹는다.'}},
      {w:'qui', ipa:'/ki/', m:{kr:'누가, 누구', en:'who'}, pos:'의문사', ex:'Qui est-ce ?', exm:{kr:'이 사람은 누구예요?'}},
      {w:"qu'est-ce que", ipa:'/kɛs kə/', m:{kr:'무엇을', en:'what'}, pos:'의문사', ex:"Qu'est-ce que c'est ?", exm:{kr:'이게 뭐예요?'}},
      {w:'où', ipa:'/u/', m:{kr:'어디', en:'where'}, pos:'의문사', ex:'Où est la gare ?', exm:{kr:'역이 어디에 있나요?'}},
      {w:'quand', ipa:'/kɑ̃/', m:{kr:'언제', en:'when'}, pos:'의문사', ex:'Quand est-ce que tu arrives ?', exm:{kr:'너 언제 도착해?'}},
      {w:'pourquoi', ipa:'/puʁ.kwa/', m:{kr:'왜', en:'why'}, pos:'의문사', ex:'Pourquoi tu étudies le français ?', exm:{kr:'너는 왜 프랑스어를 공부해?'}},
      {w:'comment', ipa:'/kɔ.mɑ̃/', m:{kr:'어떻게', en:'how'}, pos:'의문사', ex:"Comment tu t'appelles ?", exm:{kr:'너 이름이 뭐야?'}}
    ],
    grammar: [
  ...
  /* ─────────────── LEVEL 3 ─────────────── */
  {
    ...
    words: [
      {w:'fromage', ipa:'/fʁɔ.maʒ/', m:{kr:'치즈', en:'cheese'}, pos:'명사', gender:'m', plural:'fromages', ex:'Je voudrais du fromage.', exm:{kr:'치즈를 주세요.'}},
      {w:'pomme', ipa:'/pɔm/', m:{kr:'사과', en:'apple'}, pos:'명사', gender:'f', plural:'pommes', ex:'Je mange une pomme rouge.', exm:{kr:'나는 빨간 사과를 먹는다.'}},
      {w:'légume', ipa:'/le.ɡym/', m:{kr:'채소', en:'vegetable'}, pos:'명사', gender:'m', plural:'légumes', ex:'Les légumes sont bons pour la santé.', exm:{kr:'채소는 건강에 좋다.'}},
      {w:'viande', ipa:'/vjɑ̃d/', m:{kr:'고기', en:'meat'}, pos:'명사', gender:'f', plural:'viandes', ex:'Je ne mange pas de viande.', exm:{kr:'나는 고기를 먹지 않는다.'}},
      {w:'poisson', ipa:'/pwa.sɔ̃/', m:{kr:'생선', en:'fish'}, pos:'명사', gender:'m', plural:'poissons', ex:'Le poisson est frais.', exm:{kr:'생선이 신선하다.'}},
      {w:'restaurant', ipa:'/ʁɛs.tɔ.ʁɑ̃/', m:{kr:'식당', en:'restaurant'}, pos:'명사', gender:'m', plural:'restaurants', ex:'Nous allons au restaurant ce soir.', exm:{kr:'우리는 오늘 저녁 식당에 간다.'}},
      {w:'menu', ipa:'/mə.ny/', m:{kr:'메뉴', en:'menu'}, pos:'명사', gender:'m', plural:'menus', ex:"Le menu, s'il vous plaît.", exm:{kr:'메뉴판 주세요.'}},
      {w:'boisson', ipa:'/bwa.sɔ̃/', m:{kr:'음료', en:'drink'}, pos:'명사', gender:'f', plural:'boissons', ex:'Quelle boisson voulez-vous ?', exm:{kr:'어떤 음료를 드릴까요?'}},
      {w:'petit-déjeuner', ipa:'/pə.ti de.ʒø.ne/', m:{kr:'아침 식사', en:'breakfast'}, pos:'명사', gender:'m', plural:'petits-déjeuners', ex:'Je prends le petit-déjeuner à sept heures.', exm:{kr:'나는 7시에 아침을 먹는다.'}},
      {w:'délicieux / délicieuse', ipa:'/de.li.sjø(z)/', m:{kr:'맛있는', en:'delicious'}, pos:'형용사', gender:'mf', ex:'Cette tarte est délicieuse !', exm:{kr:'이 타르트 정말 맛있다!'}},
      {w:'manger', ipa:'/mɑ̃.ʒe/', m:{kr:'먹다', en:'to eat'}, pos:'동사', ex:'Je mange une pomme.', exm:{kr:'나는 사과를 먹는다.'}},
      {w:'boire', ipa:'/bwaʁ/', m:{kr:'마시다', en:'to drink'}, pos:'동사', ex:"Je bois de l'eau.", exm:{kr:'나는 물을 마신다.'}},
      {w:'commander', ipa:'/kɔ.mɑ̃.de/', m:{kr:'주문하다', en:'to order'}, pos:'동사', ex:'Nous commandons deux cafés.', exm:{kr:'우리는 커피 두 잔을 주문한다.'}},
      {w:'je voudrais', ipa:'/ʒə vu.dʁɛ/', m:{kr:'~을 주세요 (정중한 요청)', en:'I would like'}, pos:'표현', ex:"Je voudrais un croissant, s'il vous plaît.", exm:{kr:'크루아상 하나 주세요.'}},
      {w:'du / de la / des', ipa:'/dy/ /də la/ /de/', m:{kr:'약간의 (부분관사)', en:'some'}, pos:'관사', gender:'mf', ex:'Je mange du pain et de la viande.', exm:{kr:'나는 빵과 고기를 먹는다.'}}
    ],
    grammar: [
  ...
  /* ─────────────── LEVEL 4 ─────────────── */
  {
    ...
    words: [
      {w:'famille', ipa:'/fa.mij/', m:{kr:'가족', en:'family'}, pos:'명사', gender:'f', plural:'familles', ex:'Ma famille habite à Séoul.', exm:{kr:'우리 가족은 서울에 산다.'}},
      {w:'père', ipa:'/pɛʁ/', m:{kr:'아버지', en:'father'}, pos:'명사', gender:'m', plural:'pères', ex:'Mon père travaille beaucoup.', exm:{kr:'우리 아버지는 일을 많이 하신다.'}},
      {w:'mère', ipa:'/mɛʁ/', m:{kr:'어머니', en:'mother'}, pos:'명사', gender:'f', plural:'mères', ex:'Ma mère aime cuisiner.', exm:{kr:'우리 어머니는 요리를 좋아하신다.'}},
      {w:'frère', ipa:'/fʁɛʁ/', m:{kr:'형, 오빠, 남동생', en:'brother'}, pos:'명사', gender:'m', plural:'frères', ex:"J'ai deux frères.", exm:{kr:'나는 형제가 둘 있다.'}},
      {w:'sœur', ipa:'/sœʁ/', m:{kr:'누나, 언니, 여동생', en:'sister'}, pos:'명사', gender:'f', plural:'sœurs', ex:'Ma sœur est médecin.', exm:{kr:'우리 언니는 의사다.'}},
      {w:'enfant', ipa:'/ɑ̃.fɑ̃/', m:{kr:'아이, 자녀', en:'child'}, pos:'명사', gender:'mf', plural:'enfants', ex:'Les enfants jouent dans le jardin.', exm:{kr:'아이들이 정원에서 놀고 있다.'}},
      {w:'mon / ma / mes', ipa:'/mɔ̃/ /ma/ /me/', m:{kr:'나의 (소유형용사)', en:'my'}, pos:'관사', gender:'mf', ex:'mon père, ma mère, mes parents', exm:{kr:'나의 아버지, 나의 어머니, 나의 부모님'}},
      {w:'temps', ipa:'/tɑ̃/', m:{kr:'날씨; 시간', en:'weather; time'}, pos:'명사', gender:'m', plural:'temps', ex:'Quel temps fait-il ?', exm:{kr:'날씨가 어떻습니까?'}},
      {w:'pluie', ipa:'/plɥi/', m:{kr:'비', en:'rain'}, pos:'명사', gender:'f', plural:'pluies', ex:'Il pleut. / La pluie tombe.', exm:{kr:'비가 온다.'}},
      {w:'soleil', ipa:'/sɔ.lɛj/', m:{kr:'해, 태양', en:'sun'}, pos:'명사', gender:'m', plural:'soleils', ex:"Il y a du soleil aujourd'hui.", exm:{kr:'오늘은 해가 떴다.'}},
      {w:'neige', ipa:'/nɛʒ/', m:{kr:'눈', en:'snow'}, pos:'명사', gender:'f', plural:'neiges', ex:'Il neige en hiver.', exm:{kr:'겨울에는 눈이 온다.'}},
      {w:'il fait beau', ipa:'/il fɛ bo/', m:{kr:'날씨가 좋다', en:'the weather is nice'}, pos:'표현', ex:'Il fait beau, allons au parc !', exm:{kr:'날씨가 좋으니 공원에 가자!'}}
    ],
    grammar: [
  ...
  /* ─────────────── LEVEL 5 ─────────────── */
  {
    ...
    words: [
      {w:'se lever', ipa:'/sə lə.ve/', m:{kr:'일어나다', en:'to get up'}, pos:'동사', ex:'Je me lève à sept heures.', exm:{kr:'나는 7시에 일어난다.'}},
      {w:'travailler', ipa:'/tʁa.va.je/', m:{kr:'일하다, 공부하다', en:'to work'}, pos:'동사', ex:'Je travaille dans un bureau.', exm:{kr:'나는 사무실에서 일한다.'}},
      {w:'dormir', ipa:'/dɔʁ.miʁ/', m:{kr:'자다', en:'to sleep'}, pos:'동사', ex:'Je dors huit heures par nuit.', exm:{kr:'나는 밤에 8시간 잔다.'}},
      {w:'matin', ipa:'/ma.tɛ̃/', m:{kr:'아침', en:'morning'}, pos:'명사', gender:'m', plural:'matins', ex:'Le matin, je bois un café.', exm:{kr:'아침에 나는 커피를 마신다.'}},
      {w:'soir', ipa:'/swaʁ/', m:{kr:'저녁', en:'evening'}, pos:'명사', gender:'m', plural:'soirs', ex:'Ce soir, nous allons au cinéma.', exm:{kr:'오늘 저녁 우리는 영화관에 간다.'}},
      {w:'semaine', ipa:'/sə.mɛn/', m:{kr:'주, 일주일', en:'week'}, pos:'명사', gender:'f', plural:'semaines', ex:'Je travaille cinq jours par semaine.', exm:{kr:'나는 일주일에 5일 일한다.'}},
      {w:"aujourd'hui", ipa:'/o.ʒuʁ.dɥi/', m:{kr:'오늘', en:'today'}, pos:'부사', ex:"Aujourd'hui, il fait beau.", exm:{kr:'오늘은 날씨가 좋다.'}},
      {w:'demain', ipa:'/də.mɛ̃/', m:{kr:'내일', en:'tomorrow'}, pos:'부사', ex:'À demain !', exm:{kr:'내일 봐!'}}
    ],
    grammar: [
  ...
  /* ─────────────── LEVEL 6 ─────────────── */
  {
    ...
    words: [
      {w:'hier', ipa:'/jɛʁ/', m:{kr:'어제', en:'yesterday'}, pos:'부사', ex:'Hier, j’ai mangé au restaurant.', exm:{kr:'어제 나는 식당에서 먹었다.'}},
      {w:'déjà', ipa:'/de.ʒa/', m:{kr:'이미, 벌써', en:'already'}, pos:'부사', ex:'J’ai déjà fini.', exm:{kr:'나는 이미 끝냈다.'}},
      {w:'week-end', ipa:'/wi.kɛnd/', m:{kr:'주말', en:'weekend'}, pos:'명사', gender:'m', plural:'week-ends', ex:'Le week-end, je me repose.', exm:{kr:'주말에 나는 쉰다.'}},
      {w:'vacances', ipa:'/va.kɑ̃s/', m:{kr:'방학, 휴가 (항상 복수)', en:'vacation'}, pos:'명사', gender:'f', ex:'Je suis en vacances.', exm:{kr:'나는 휴가 중이다.'}},
      {w:'musée', ipa:'/my.ze/', m:{kr:'박물관', en:'museum'}, pos:'명사', gender:'m', plural:'musées', ex:'Nous avons visité un musée.', exm:{kr:'우리는 박물관을 관람했다.'}},
      {w:'voyager', ipa:'/vwa.ja.ʒe/', m:{kr:'여행하다', en:'to travel'}, pos:'동사', ex:'J’aime voyager en Europe.', exm:{kr:'나는 유럽 여행을 좋아한다.'}},
      {w:'visiter', ipa:'/vi.zi.te/', m:{kr:'(장소를) 방문하다', en:'to visit'}, pos:'동사', ex:'Ils ont visité Paris.', exm:{kr:'그들은 파리를 방문했다.'}},
      {w:'acheter', ipa:'/aʃ.te/', m:{kr:'사다', en:'to buy'}, pos:'동사', ex:'Elle a acheté du pain.', exm:{kr:'그녀는 빵을 샀다.'}},
      {w:'prendre', ipa:'/pʁɑ̃dʁ/', m:{kr:'잡다, 타다, 먹다', en:'to take'}, pos:'동사', ex:'Je prends le bus.', exm:{kr:'나는 버스를 탄다.'}},
      {w:'voir', ipa:'/vwaʁ/', m:{kr:'보다', en:'to see'}, pos:'동사', ex:'Nous avons vu un film.', exm:{kr:'우리는 영화를 봤다.'}}
    ],
    grammar: [
  ...
  /* ─────────────── LEVEL 7 ─────────────── */
  {
    ...
    words: [
      {w:'souvent', ipa:'/su.vɑ̃/', m:{kr:'자주', en:'often'}, pos:'부사', ex:'Je vais souvent au cinéma.', exm:{kr:'나는 영화관에 자주 간다.'}},
      {w:'toujours', ipa:'/tu.ʒuʁ/', m:{kr:'항상', en:'always'}, pos:'부사', ex:'Il est toujours en retard.', exm:{kr:'그는 항상 늦는다.'}},
      {w:'jamais', ipa:'/ʒa.mɛ/', m:{kr:'결코 ~않다 (ne...jamais)', en:'never'}, pos:'부사', ex:'Je ne bois jamais de café.', exm:{kr:'나는 커피를 절대 마시지 않는다.'}},
      {w:'avant', ipa:'/a.vɑ̃/', m:{kr:'전에, 이전에', en:'before'}, pos:'전치사', ex:'Avant, j’habitais à Busan.', exm:{kr:'예전에 나는 부산에 살았다.'}},
      {w:'après', ipa:'/a.pʁɛ/', m:{kr:'후에', en:'after'}, pos:'전치사', ex:'Après le dîner, je lis.', exm:{kr:'저녁 식사 후에 나는 책을 읽는다.'}},
      {w:'année', ipa:'/a.ne/', m:{kr:'해, 연도', en:'year'}, pos:'명사', gender:'f', plural:'années', ex:'Bonne année !', exm:{kr:'새해 복 많이 받으세요!'}},
      {w:'prochain / prochaine', ipa:'/pʁɔ.ʃɛ̃(n)/', m:{kr:'다음의', en:'next'}, pos:'형용사', gender:'mf', ex:'la semaine prochaine', exm:{kr:'다음 주'}},
      {w:'dernier / dernière', ipa:'/dɛʁ.nje(ʁ)/', m:{kr:'지난, 마지막의', en:'last'}, pos:'형용사', gender:'mf', ex:'l’année dernière', exm:{kr:'작년'}},
      {w:'habiter', ipa:'/a.bi.te/', m:{kr:'살다, 거주하다', en:'to live'}, pos:'동사', ex:'J’habite à Séoul.', exm:{kr:'나는 서울에 산다.'}},
      {w:'jouer', ipa:'/ʒwe/', m:{kr:'놀다, (악기·경기를) 하다', en:'to play'}, pos:'동사', ex:'Les enfants jouent au football.', exm:{kr:'아이들이 축구를 한다.'}}
    ],
    grammar: [
  ...
  /* ─────────────── LEVEL 8 ─────────────── */
  {
    ...
    words: [
      {w:'y', ipa:'/i/', m:{kr:'거기에, 그것에 (장소 대명사)', en:'there'}, pos:'대명사', ex:'— Tu vas à Paris ? — Oui, j’y vais.', exm:{kr:'— 파리 가? — 응, 거기 가.'}},
      {w:'en', ipa:'/ɑ̃/', m:{kr:'그것을(의) (수량 대명사)', en:'of it/them'}, pos:'대명사', ex:'— Tu as des frères ? — Oui, j’en ai deux.', exm:{kr:'— 형제 있어? — 응, 둘 있어.'}},
      {w:'le / la / les (목적어)', ipa:'/lə/ /la/ /le/', m:{kr:'그를/그녀를/그것들을 (직접목적어)', en:'him/her/them'}, pos:'대명사', gender:'mf', ex:'Je le connais bien.', exm:{kr:'나는 그를 잘 안다.'}},
      {w:'lui / leur', ipa:'/lɥi/ /lœʁ/', m:{kr:'그(녀)에게 / 그들에게 (간접목적어)', en:'to him/her/them'}, pos:'대명사', ex:'Je lui parle tous les jours.', exm:{kr:'나는 매일 그(녀)에게 말한다.'}},
      {w:'avoir faim', ipa:'/a.vwaʁ fɛ̃/', m:{kr:'배고프다', en:'to be hungry'}, pos:'표현', ex:'J’ai très faim !', exm:{kr:'나 정말 배고파!'}},
      {w:'avoir soif', ipa:'/a.vwaʁ swaf/', m:{kr:'목마르다', en:'to be thirsty'}, pos:'표현', ex:'Tu as soif ? Voilà de l’eau.', exm:{kr:'목말라? 여기 물 있어.'}},
      {w:'avoir besoin de', ipa:'/a.vwaʁ bə.zwɛ̃ də/', m:{kr:'~이 필요하다', en:'to need'}, pos:'표현', ex:'J’ai besoin de dormir.', exm:{kr:'나는 잠이 필요하다.'}},
      {w:'il y a', ipa:'/il.ja/', m:{kr:'~이 있다', en:'there is/are'}, pos:'표현', ex:'Il y a un chat sur la table.', exm:{kr:'탁자 위에 고양이가 있다.'}},
      {w:'penser à', ipa:'/pɑ̃.se a/', m:{kr:'~을 생각하다', en:'to think about'}, pos:'동사', ex:'Je pense à mes vacances.', exm:{kr:'나는 휴가를 생각한다.'}},
      {w:'connaître', ipa:'/kɔ.nɛtʁ/', m:{kr:'알다 (사람·장소)', en:'to know'}, pos:'동사', ex:'Je connais ce restaurant.', exm:{kr:'나는 이 식당을 안다.'}}
    ],
    grammar: [
  ...
  /* ─────────────── LEVEL 9 ─────────────── */
  {
    ...
    words: [
      {w:'penser', ipa:'/pɑ̃.se/', m:{kr:'생각하다', en:'to think'}, pos:'동사', ex:'Je pense que c’est une bonne idée.', exm:{kr:'좋은 생각인 것 같아.'}},
      {w:'croire', ipa:'/kʁwaʁ/', m:{kr:'믿다, ~라고 생각하다', en:'to believe'}, pos:'동사', ex:'Je crois qu’il a raison.', exm:{kr:'그가 옳다고 생각해.'}},
      {w:'il faut que', ipa:'/il fo kə/', m:{kr:'~해야 한다 (+subjonctif)', en:'it is necessary that'}, pos:'표현', ex:'Il faut que tu sois à l’heure.', exm:{kr:'너는 제시간에 와야 해.'}},
      {w:'bien que', ipa:'/bjɛ̃ kə/', m:{kr:'비록 ~이지만 (+subjonctif)', en:'although'}, pos:'접속사', ex:'Bien qu’il soit fatigué, il travaille.', exm:{kr:'그는 피곤하지만 일한다.'}},
      {w:'à mon avis', ipa:'/a mɔ̃.n‿a.vi/', m:{kr:'내 생각에는', en:'in my opinion'}, pos:'표현', ex:'À mon avis, ce film est excellent.', exm:{kr:'내 생각에 이 영화는 훌륭하다.'}},
      {w:'avis', ipa:'/a.vi/', m:{kr:'의견', en:'opinion'}, pos:'명사', gender:'m', plural:'avis', ex:'Quel est ton avis ?', exm:{kr:'네 의견은 뭐야?'}},
      {w:'important / importante', ipa:'/ɛ̃.pɔʁ.tɑ̃(t)/', m:{kr:'중요한', en:'important'}, pos:'형용사', gender:'mf', ex:'C’est une décision importante.', exm:{kr:'이것은 중요한 결정이다.'}},
      {w:'nécessaire', ipa:'/ne.se.sɛʁ/', m:{kr:'필요한', en:'necessary'}, pos:'형용사', gender:'mf', ex:'Il est nécessaire de pratiquer.', exm:{kr:'연습이 필요하다.'}},
      {w:'sembler', ipa:'/sɑ̃.ble/', m:{kr:'~인 것 같다', en:'to seem'}, pos:'동사', ex:'Il semble content.', exm:{kr:'그는 만족스러워 보인다.'}},
      {w:'avoir raison', ipa:'/a.vwaʁ ʁɛ.zɔ̃/', m:{kr:'옳다, 맞다', en:'to be right'}, pos:'표현', ex:'Tu as raison, c’est vrai.', exm:{kr:'네 말이 맞아, 사실이야.'}}
    ],
    grammar: [
  ...
  /* ─────────────── LEVEL 10 ─────────────── */
  {
    ...
    words: [
      {w:'cependant', ipa:'/sə.pɑ̃.dɑ̃/', m:{kr:'그러나 (격식)', en:'however'}, pos:'접속사', ex:'Le film était long ; cependant, je ne me suis pas ennuyé.', exm:{kr:'영화는 길었다. 그러나 지루하지 않았다.'}},
      {w:'pourtant', ipa:'/puʁ.tɑ̃/', m:{kr:'그렇지만, 그런데도', en:'yet, nevertheless'}, pos:'부사', ex:'Il est riche, pourtant il n’est pas heureux.', exm:{kr:'그는 부자지만 행복하지 않다.'}},
      {w:'néanmoins', ipa:'/ne.ɑ̃.mwɛ̃/', m:{kr:'그럼에도 불구하고 (문어)', en:'nonetheless'}, pos:'부사', ex:'C’est difficile ; néanmoins, j’essaierai.', exm:{kr:'어렵다. 그럼에도 시도해 보겠다.'}},
      {w:'malgré', ipa:'/mal.ɡʁe/', m:{kr:'~에도 불구하고', en:'despite'}, pos:'전치사', ex:'Malgré la pluie, nous sommes sortis.', exm:{kr:'비에도 불구하고 우리는 나갔다.'}},
      {w:'afin de', ipa:'/a.fɛ̃ də/', m:{kr:'~하기 위하여 (격식)', en:'in order to'}, pos:'전치사', ex:'J’étudie afin de réussir.', exm:{kr:'나는 성공하기 위해 공부한다.'}},
      {w:'si', ipa:'/si/', m:{kr:'만약 ~라면', en:'if'}, pos:'접속사', ex:'Si j’étais riche, je voyagerais.', exm:{kr:'내가 부자라면 여행할 텐데.'}},
      {w:'pouvoir (je pourrais)', ipa:'/pu.vwaʁ/', m:{kr:'~할 수 있다 (조건법: ~할 수 있을 텐데요)', en:'could'}, pos:'동사', ex:'Pourriez-vous m’aider ?', exm:{kr:'저를 도와주실 수 있을까요?'}},
      {w:'devoir (je devrais)', ipa:'/də.vwaʁ/', m:{kr:'~해야 한다 (조건법: ~하는 게 좋겠다)', en:'should'}, pos:'동사', ex:'Tu devrais dormir plus.', exm:{kr:'너는 잠을 더 자는 게 좋겠어.'}},
      {w:'souhaiter', ipa:'/swɛ.te/', m:{kr:'바라다, 기원하다', en:'to wish'}, pos:'동사', ex:'Je souhaiterais réserver une table.', exm:{kr:'테이블을 예약하고 싶습니다만.'}},
      {w:'exprimer', ipa:'/ɛks.pʁi.me/', m:{kr:'표현하다', en:'to express'}, pos:'동사', ex:'Il exprime bien ses idées.', exm:{kr:'그는 자기 생각을 잘 표현한다.'}}
    ],
    grammar: [
