/* =====================================================================
   ...
   · 읽던 위치·글자 크기·세로쓰기 여부는 기기에 저장돼, 다시 열면 그대로 이어집니다.
   · 본문에 한중일 문자가 있으면 **세로쓰기 버튼**이 자동으로 생깁니다.
     팩에 따로 적을 것이 없습니다 — 엔진이 본문을 보고 정합니다.
   · 青空文庫 파일은 tools/aozora.py 가 루비·입력자 주를 풀어 바로 넣어 줍니다.
